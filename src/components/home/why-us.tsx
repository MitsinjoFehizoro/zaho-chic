...
export function WhyUs() {
	...
	return (
		<section id="why-us" className="flex flex-col items-center pt-12 pb-32 bg-gradient-to-b from-tertiary via-tertiary/1 to-transparent">
			...
			<BigRoundNavLink link="/shop" title="Buy now" className="bg-primary my-12" isWithIcon={true} />
